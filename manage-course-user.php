...
<section>
    <div class="container">
        <div class="row align-items-start">
            <form class="col-xl-12 col-lg-6 col-md-12 col-sm-12" method="posst" action="action-manage-course-user.php"
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <input name="Link" type="text" class="form-control" placeholder="http://..." />
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="form-group">
                            <button class="btn theme-bg text-white btn-md" type="submit">ویرایش دوره</button>
                        </div>
                    </div>
                </div>
            </form>
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td> 2</td>
                    <td>
                        <a href="action-class-manage.phpj?id=">حذف</a>
                        &nbsp;|&nbsp;
                        <a href="action-class-manage.phpj?id=">ویرایش</a>
